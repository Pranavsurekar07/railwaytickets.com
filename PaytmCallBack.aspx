<%@ Page Title="" Language="C#" MasterPageFile="~/MainMaster.Master" AutoEventWireup="true" CodeBehind="PaytmCallBack.aspx.cs" Inherits="RailwayTicketingProject.PaytmCallBack" %>
                ...
                <div class="col-md-12">
                    <div class="my-breadcrumb">
                        <ul>
                            ...
                            <li>Add Balance</li>
                            <li>
                                <asp:HyperLink ID="linkpaytmcallback" NavigateUrl="#PaytmCallBack.aspx" runat="server" CssClass="active">Payment Status</asp:HyperLink></li>
                        </ul>
                    </div>
                    <!--my-breadcrumb-->
                ...
                <div class="col-md-12">
                    <div class="form-card-wrp mb-4">
                        <div class="subscribe-wrp-card userprofile-wrp form-card">
                            ...
                            <div class="topuser-profile d-flex space-between flex-wrp">
                               <h3><asp:Label CssClass="text-center" runat="server" ID="h1Message"></asp:Label></h3>                                
                            </div>
